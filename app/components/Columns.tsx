...
const Columns: React.FC<ColumnBlock> = ({ layout, column1, column2, column3, _type }) => {
    ...
    return (
        <div className={`${_type} ${layout === 'three' ? 'three-columns' : 'two-columns'} flex flex-col items-start xl:flex-row w-full `}>
            {columns.map((column, columnIndex) => (
                <div key={columnIndex} className="column w-full flex flex-row justify-center">
