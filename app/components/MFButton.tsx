...
export const buttonStyle = tv({
    ...
    variants: {
        styling: {
            ...
            smallbg: 'h-6 bg-custom-beige hover:bg-off-white m-5 p-4 md:p-6 rounded-2xl text-black border-2 border-black text-lg hover:shadow-button transition-all duration-100 hover:translate-x-1 hover:-transltate-y-1 active:shadow-none active:translate-x-0 active:translate-y-0 active:bg-slate-500',
