...
const Footer: React.FC<Props> = ({tabs, contacts}) => {
    return(
        <div className="flex flex-row items-center px-52 bg-primary h-[400px] font-text text-lg text-off-white border-[5px] border-black">
            <div className="w-[33%] h-[70%] text-xl flex flex-col justify-center items-center">
            ...
            <div className="w-[33%] h-[70%]  flex flex-col justify-center items-center">
