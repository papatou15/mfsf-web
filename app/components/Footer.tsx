...
const Footer: React.FC<Props> = ({ tabs, contacts, logo }) => {
    ...
    return (
        <div className={`footer-wrapper lg:p-9 ${background}`}>
            <div className="footer flex flex-col lg:flex-row items-center justify-around px-20  bg-gradient-to-br lg:bg-gradient-to-l from-primary-blue to-[#0D5E68] lg:h-[400px] lg:rounded-2xl text-lg text-off-white ">
