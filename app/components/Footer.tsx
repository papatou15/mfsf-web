        ...
        <div className={`footer-wrapper lg:p-9 ${background}`}>
            <div className="footer flex flex-col lg:flex-row items-center justify-center px-20  bg-gradient-to-br lg:bg-gradient-to-l from-primary-blue to-[#0D5E68] lg:h-[400px] lg:rounded-2xl text-lg text-off-white ">
                <div className="lg:h-[70%] text-xl flex flex-col justify-center items-center">
                    ...
                    {tabs ? tabs.map((tab) =>
                        <div key={tab._id} className={`${typographyTheme({ size: 'footnote' })} py-1 text-shadow-sm`}>
                            {tab.title}
                        </div>
                    ) : "no tabs"}
                </div>
                <div className="min-w-44 lg:min-w-64 lg:max-w-96 flex flex-col items-center justify-center mx-16">
                    ...
                    <Typography as="p" className={`${typographyTheme({size: 'footnote'})} text-shadow-sm mt-4`}>Maison de la famille de St-François © 2024</Typography>
                </div>
                <div className=" lg:h-[70%] flex flex-col justify-center items-center text-shadow-sm">
                    <div className="flex flex-col p-3 items-center">
                        <Typography as="h3" className={`${typographyTheme({size: 'h5'})} text-shadow py-3`}>Pour nous joindre</Typography>
                    ...
                    <div className="flex flex-col p-3 items-center">
                        <Typography as="h3" className={`${typographyTheme({size: 'h5'})} text-shadow py-3`}>Liens utiles:</Typography>
